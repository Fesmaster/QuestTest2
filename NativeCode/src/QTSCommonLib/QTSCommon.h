...
public:
    ...
    static int GetLinuxKeyFromMinetestKey(int Key);

    static int GetMinetestKeyFromLinuxKey(int Key);

private:
    static void InitKeyPair(int LinuxKey, int MinetestKey);

    static bool bInitalized;
    static std::unordered_map<int, int> LinuxToMinetest;
    static std::unordered_map<int, int> MinetestToLinux;
};
