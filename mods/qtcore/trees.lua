...
qts.worldgen.register_structure("tree_coffee", {
	...
	chance = 80,
	biomes = {"rainforest"},
	nodes = {"overworld:dirt_with_rainforest_grass"},
	force_place = false,
	rotate = true,
	flags = qts.worldgen.centers(true, false, true),
})
...
qts.worldgen.register_structure("tree_rosewood1", {
	...
	chance = 70,
	biomes = {"prarie"},
	nodes = {"overworld:dirt_with_prarie_grass"},
	force_place = false,
	rotate = true,
	flags = qts.worldgen.centers(true, false, true),
})
...
qts.worldgen.register_structure("tree_swamp", {
	...
	chance = 70,
	biomes = {"swamp"},
	nodes = {"overworld:dirt_with_swamp_grass"},
	force_place = false,
	rotate = true,
	flags = qts.worldgen.centers(true, false, true),
})
...
qts.worldgen.register_structure("tree_small_blue_shroom", {
	...
	nodes = {"overworld:loam_with_mushroom_grass"},
	force_place = false,
	rotate = true,
	flags = qts.worldgen.centers(true, false, true),
})
...
qts.worldgen.register_structure("tree_pine", {
	...
	chance = 90,
	biomes = {"snow"},
	nodes = {"overworld:dirt_with_snow"},
	force_place = false,
	rotate = true,
	flags = qts.worldgen.centers(true, false, true),
})