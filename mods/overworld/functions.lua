...
local reed_growth_rate = qts.config("REED_GROWTH", 12, "reed growth interval", {loadtime=true})
local reed_growth_chance = qts.config("REED_GROWTH_CHANCE", 15, "reed growth chance", {loadtime=true})
