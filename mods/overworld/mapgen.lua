...
qts.worldgen.register_biome("desert", {
	...
	plant = "overworld:underbrush_cactus_barrel",
	plant_freq = 50,
	surface_depth = 5,
	fill_depth = 10,
	stone_depth = 20,
...
qts.worldgen.register_biome("snow", {
	...
	fill = "overworld:dirt",
	stone = "overworld:granite",
	plant = {"overworld:grass_cotton_tall", "overworld:grass_cotton_short", "overworld:ground_willow", "overworld:flower_arctic_poppy"},
	plant_freq = 20,
	surface_depth = 1,
	fill_depth = 2,
	stone_depth = 0,
