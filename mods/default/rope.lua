...
qts.register_craft({
	...
	results = {"default:rope"},
})

qts.register_craft({
	ingredients = {"default:copper_bar 1"},
	results = {"default:chain_copper"},
	near = {"group:workbench"},
})

qts.register_craft({
	ingredients = {"default:bronze_bar 1"},
	results = {"default:chain_bronze"},
	near = {"group:workbench"},
})

qts.register_craft({
	ingredients = {"default:iron_bar 1"},
	results = {"default:chain_iron"},
	near = {"group:furnace", "default:anvil"},
})

qts.register_craft({
	ingredients = {"default:steel_bar 1"},
	results = {"default:chain_steel"},
	near = {"group:furnace", "default:anvil"},
})
