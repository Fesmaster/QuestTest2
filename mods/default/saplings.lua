...
qts.register_growable_node("default:oak_sapling", {
	...
	on_grow = function(pos)
		minetest.log("An Oak tree has grown at "..minetest.pos_to_string(pos))
...
qts.register_growable_node("default:aspen_sapling", {
	...
	grow_timer_random = TREE_VAR,
	on_grow = function(pos)
		minetest.log("An Aspen tree has grown at "..minetest.pos_to_string(pos))
		minetest.set_node(pos, {name = "air"})
...
qts.register_growable_node("default:apple_sapling", {
	...
	grow_timer_random = TREE_VAR,
	on_grow = function(pos)
		minetest.log("An Apple tree has grown at "..minetest.pos_to_string(pos))
		minetest.set_node(pos, {name = "air"})
...
qts.register_growable_node("default:rowan_sapling", {
	...
	grow_timer_random = TREE_VAR,
	on_grow = function(pos)
		minetest.log("An Rowan tree has grown at "..minetest.pos_to_string(pos))
		minetest.set_node(pos, {name = "air"})
...
qts.register_growable_node("default:lanternfruit_sapling", {
	...
	grow_timer_random = TREE_VAR,
	on_grow = function(pos)
		minetest.log("An Lanternfruit tree has grown at "..minetest.pos_to_string(pos))
		minetest.set_node(pos, {name = "air"})
...
qts.register_growable_node("default:coffeetree_sapling", {
	...
	grow_timer_random = TREE_VAR,
	on_grow = function(pos)
		minetest.log("An Coffeetree has grown at "..minetest.pos_to_string(pos))
		minetest.set_node(pos, {name = "air"})
...
qts.register_growable_node("default:mahogany_sapling", {
	...
	grow_timer_random = TREE_VAR,
	on_grow = function(pos)
		minetest.log("An Mahogany tree has grown at "..minetest.pos_to_string(pos))
		minetest.set_node(pos, {name = "air"})
...
qts.register_growable_node("default:rosewood_sapling", {
	...
	grow_timer_random = TREE_VAR,
	on_grow = function(pos)
		minetest.log("An Rosewood tree has grown at "..minetest.pos_to_string(pos))
		minetest.set_node(pos, {name = "air"})
