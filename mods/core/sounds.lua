...
function core.node_sound_dirt(table)
	table = table or {}
	table.footstep = table.footstep or
...
function core.node_sound_sand(table)
	table = table or {}
	table.footstep = table.footstep or
...
function core.node_sound_grass(table)
	table = table or {}
	table.footstep = table.footstep or
...
function core.node_sound_stone(table)
	table = table or {}
	table.footstep = table.footstep or
...
function core.node_sound_wood(table)
	table = table or {}
	table.footstep = table.footstep or
...
function core.node_sound_metal(table)
	table = table or {}
	table.footstep = table.footstep or
...
function core.node_sound_glass(table)
	table = table or {}
	table.footstep = table.footstep or
