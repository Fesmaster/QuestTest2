...
qts.gui.register_gui("craftable_gui_furnace", {
	get = function(data, pos, name)
		...
		minetest.after(0.8, function(pos, name)
			if qts.gui.get_open_gui(name) == "craftable_gui_furnace" then
				qts.gui.show_gui(pos, name, "craftable_gui_furnace")
			end
		end, pos, name)
...
local function register_furnace(name, def)
	...
	minetest.register_node(name, {
		...
		on_rightclick = function(pos, node, clicker, itemstack, pointed_thing)
			qts.gui.show_gui(pos, clicker, "craftable_gui_furnace")
		end,
